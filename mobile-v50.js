(()=>{
  ...
  function openSettings(){
    const dialog=qs('#agpSettingsDialog');
    if(dialog?.showModal){dialog.showModal();return}
    qs('#agpSettingsBtn')?.click();
  }
